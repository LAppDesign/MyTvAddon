...
.content, .config-form, .advanced-settings, #confirmModal > div, #pythonStatus, #generatedM3uUrl, #resolverStatus {
 ...
 border-radius: 12px !important;
           ...
           body {
               ...
               color: #fff;
               background: var(--bg-color); /* Alterado de 'purple' para o gradiente cinza */
           }
           #background-video {
               position: fixed;
               right: 0;
...
`
                <div class="advanced-settings">
                        <div 
class="advanced-settings-header" onclick="toggleAdvancedSettings()">
...
''}">
                     ${showConfigFields ? `<input type="submit" value="Gerar Configuração">` : ``}
                 </form>
...
display: block; margin-top: 5px;">
                             ...
                             <div id="pythonStatus" style="margin-top: 15px;
...
Python que implemente a função <code>resolve_link</code>.</strong></p>
                         </div>
...
display: block; margin-top: 5px;">
                             ...
                             <div id="resolverStatus" style="margin-top: 15px;
background: rgba(0,0,0,0.3); padding: 10px; border-radius: 4px; display: none;">
...
color: #ccc;">
                 ${showConfigFields ? ` <p>Addon criado com paixão por McCoy88f - <a href="https://github.com/mccoy88f/OMG-Premium-TV" target="_blank">GitHub Repository</a></p>
                 <p>Addon editado por LAppDesign.</p> <h3 style="margin-top: 20px;">Apoia este projeto!</h3>
                 
            
                 <div style="margin-top: 15px;">
                     <a href="https://www.buymeacoffee.com/mccoy88f" target="_blank">
                         <img src="https://img.buymeacoffee.com/button-api/?text=Oferece-me uma cerveja&emoji=🍺&slug=mccoy88f&button_colour=FFDD00&font_colour=000000&font_family=Bree&outline_colour=000000&coffee_colour=ffffff" alt="Buy Me a Coffee" style="max-width: 300px;
margin: 0 auto;"/>
                     </a>
                 </div>
