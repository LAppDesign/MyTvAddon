...
const renderConfigPage = (protocol, host, query, manifest) => {
  ...
  const m3uDefaultUrl = 'https://github.com/LAppDesign/MyTvAddon/blob/main/tv.png?raw=true'; // Não usado diretamente agora



  // --- ALTERAÇÃO AQUI (NOVA VARIÁVEL) ---
                      ...
                      <div class="advanced-settings-content" id="resolver-section-content">
                          ...
                          <div id="resolverForm">
                              ...
                              <div style="display: flex; gap: 10px; margin-top: 15px;">
                                  ...
                                  <button onclick="checkResolverHealth()" style="flex:
